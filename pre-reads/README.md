...
Learner-facing briefing for each live Altius scenario (same text as in-app pre-read). Filenames use the scenario title. Buckets match corporate vs education catalogue.

| Title | Bucket | moduleId | Landing page |
|-------|--------|----------|--------------|
| A Decision I Didn't Make | corporate | `change-communication-disagree-commit` | https://altius.adegreeabove.org/demos/change-communication-disagree-commit/ |
| A Reasonable Request | corporate | `reasonable-request` | https://altius.adegreeabove.org/demos/reasonable-request/ |
...
| The Conversation Nobody Wants | corporate | `performance-conversation-pip-sbi` | https://altius.adegreeabove.org/demos/performance-conversation-pip-sbi/ |
| The Escalation | corporate | `customer-success-renewals` | https://altius.adegreeabove.org/demos/customer-success-renewals/ |
| The Falcon Ultimatum | corporate | `vikram-sales` | https://altius.adegreeabove.org/demos/vikram-sales/ |
| The Green RAG | corporate | `difficult-feedback` | https://altius.adegreeabove.org/demos/difficult-feedback/ |
| The Home Loan | corporate | `banking-loan-advisory-spin` | https://altius.adegreeabove.org/demos/banking-loan-advisory-spin/ |
| The Inconvenient Finding | corporate | `consulting-client-pushback-state` | https://altius.adegreeabove.org/demos/consulting-client-pushback-state/ |
| The Meltdown | corporate | `vikram-service` | https://altius.adegreeabove.org/demos/vikram-service/ |
| The Nordic Standard | corporate | `design-build-gcc-norway` | https://altius.adegreeabove.org/demos/design-build-gcc-norway/ |
| The Promise | corporate | `fmcg-distributor-negotiation` | https://altius.adegreeabove.org/demos/fmcg-distributor-negotiation/ |
| The Right Desk | corporate | `gov-regulatory-influence-without-authority` | https://altius.adegreeabove.org/demos/gov-regulatory-influence-without-authority/ |
| The Status Call | corporate | `gcc-cross-cultural-escalation-aaa` | https://altius.adegreeabove.org/demos/gcc-cross-cultural-escalation-aaa/ |
| The Undercut | corporate | `telecom-enterprise-renewal-challenger` | https://altius.adegreeabove.org/demos/telecom-enterprise-renewal-challenger/ |
...
| The Ten Minutes | education | `nursing-communication-adverse-candor` | https://altius.adegreeabove.org/demos/nursing-communication-adverse-candor/ |
| The Unnamed Source | education | `hr-difficult-conversations` | https://altius.adegreeabove.org/demos/hr-difficult-conversations/ |
| What's Fair Here | education | `divorce-custody-counselling` | https://altius.adegreeabove.org/demos/divorce-custody-counselling/ |
